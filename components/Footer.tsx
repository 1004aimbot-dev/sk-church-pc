      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 items-start mb-8">
          <div className="space-y-3">
            <h2 className="font-myeongjo text-xl font-bold text-white mb-2">성남신광교회</h2>
          ...
          <div className="space-y-3">
            <h3 className="text-white font-bold text-xs uppercase tracking-widest">Contact Info</h3>
            <p className="text-xs leading-relaxed">
          ...
          <div className="md:text-right space-y-4">
            ...
            <div className="flex gap-3 md:justify-end">
              <a href="#" className="size-8 rounded-full bg-slate-800 flex items-center justify-center hover:bg-blue-600 text-white transition-all"><span className="material-symbols-outlined text-base">public</span></a>
              <a href="#" className="size-8 rounded-full bg-slate-800 flex items-center justify-center hover:bg-red-600 text-white transition-all"><span className="material-symbols-outlined text-base">videocam</span></a>
              <a href="#" className="size-8 rounded-full bg-slate-800 flex items-center justify-center hover:bg-blue-400 text-white transition-all"><span className="material-symbols-outlined text-base">mail</span></a>
            </div>
          </div>
        </div>
