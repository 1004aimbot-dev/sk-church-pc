...
const AIGuide: React.FC = () => {
  // ... (state lines 16-52 remain unchanged, will rely on existing file content for context if replace tool allows partial. 
  // Wait, I need to match exact context or replace the whole function logic. 
  // Let's replace the import and the handleSend function.)

  /* 
     Actually, replace_file_content requires exact TargetContent. 
     I will Replace the import first, then handleSend.
  */
